...
let titleText = healthHeader.addText("Health");
...
let timeText = healthHeader.addText(timeFormatter.string(dateObj));
timeText.font = Font.systemFont(9, 'medium');
timeText.textColor = new Color("#FFD60A"); 

// Matches the space below the calendar header
healthCol.addSpacer(9);
...
function addHealthRow(label, value, unit) {
  ...
  if (unit) {
    ...
    u.font = Font.systemFont(10, 'regular');
